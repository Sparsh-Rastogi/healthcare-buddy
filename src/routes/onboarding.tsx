...
export const Route = createFileRoute("/onboarding")({
  head: () => ({
    meta: [
      { title: "Welcome — Healthcare Buddy" },
      { name: "description", content: "Set up your health profile in a few quick steps." },
    ],
  }),
...
function Step1({ profile, setProfile }: { profile: Profile; setProfile: (p: Profile) => void }) {
  return (
    <div>
      <Heading title="Welcome 👋" sub="A few basics so we can personalize your buddy." />
