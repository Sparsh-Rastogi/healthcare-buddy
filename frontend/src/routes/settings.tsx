      ...
      <div className="space-y-2 text-sm">
        ...
        {isDemo && (
          <p className="text-xs text-muted-foreground rounded-lg bg-muted/60 p-2">
            Demo mode — add Supabase env vars for persistent accounts.
          </p>
        )}
      </div>
      <Button
    ...
    <Card className="border-destructive/30">
      ...
      <CardContent>
        ...
        <ConfirmDialog
          ...
          title="Reset all Baymax data?"
          description="Profile, conditions, meds, logs, periods, and reports will be permanently deleted from this device. Your account stays signed in."
